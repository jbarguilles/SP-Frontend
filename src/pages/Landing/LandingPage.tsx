  ...
  return (
    <div className="landing-container">
      ...
      <div className="text-container">
        ...
        <button
          className="mt-15 px-6 py-3 bg-[#800000] text-white rounded-lg shadow-lg hover:bg-[#990000] hover:shadow-xl border-2 border-[#600000] font-semibold transform hover:scale-105 transition-all duration-200 cursor-pointer"
